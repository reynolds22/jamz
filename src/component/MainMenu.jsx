...
function MainMenu() {
    ...
    useEffect(() => {
        ...
        console.log("Loaded playlists from local storage:", savedPlaylists);
        if (savedPlaylists) {
    ...
    useEffect(() => {
        console.log("Saving playlists to local storage:", playlists);
        ...
        return (
            <div className="playlist-edit">
                ...
                <div className="playlist-info">
                    ...
                    <h5 className="whats-working">This part of the app/site does not have working buttons for play and shuffle these a for looks. Along with any of the songs are not able to be listened too.</h5>
                </div>
